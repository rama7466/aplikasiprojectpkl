...
class TblhouseControllers extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('tblhouse.index', compact('departemen',$departemen ,'kode_prosedur',$kode_prosedur,'kategori_prosedur',$kategori_prosedur,'tblcrupp',$tblcrupp));
    }
